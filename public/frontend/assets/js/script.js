...
function addNumPanel(){
    $(".numPanel").last().after("<div class='row numPanel'><div class='col-3 mb-2'><input type='number' name='numbers[]' id='numbers[]' class='nums' placeholder='Number' maxlength="+maxval+" required /></div><div class='col-3 mb-2'><input type='number' name='counts[]' min='1' max='999' step='1' class='counts' placeholder='Count' maxlength='3' required /></div><div class='col-4'><input type='number' class='rowTot' placeholder='0.00' readonly></div><div class='col-2'><a href='javascript:void(0)' class='dlt'><i class='fa fa-trash'></i></a></div></div>");
    $(".nums").last().focus();
