            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center py-2">
                    <ol class="breadcrumb rounded-0 mb-0 ps-0 bg-transparent flex-grow-1">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create Play</li>
                    </ol>
                </div>
            </div>
        </div> <!-- .row end -->
        ...
        <div class="row g-3 clearfix">
            <div class="card mb-2">
                <div class="card-body p-4">
                    <form action="{{ route('play.save') }}" method="post">
                        @csrf
                        <div class="row g-4">
                            <div class="col-sm-3">
                                <label class="form-label req">Play Name</label>
                                <input type="text" value="{{ old('name') }}" name="name" class="form-control form-control-md" placeholder="Play Name">
                                @error('name')
                            ...
                            <div class="col-sm-2">
                                ...
                                {{ html()->time($name = 'entry_locked_from', $value = old('entry_locked_from'))->class('form-control form-control-md') }}
                            ...
                            <div class="col-sm-2">
                                ...
                                {{ html()->time($name = 'entry_locked_to', $value = old('entry_locked_to'))->class('form-control form-control-md') }}
