                    ...
                    <form action="{{ route('user.update', $user->id) }}" method="post">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" value="{{ $user->username }}" name="username" class="form-control form-control-md" placeholder="Username">
                                @error('username')
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" value="{{ $user->phone }}" name="phone" class="form-control form-control-md" placeholder="Phone" maxlength="10">
                                @error('phone')
