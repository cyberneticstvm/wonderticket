...
<body class="" data-theme-color="color-red">
<div class="page-wraper">
    ...
    <div class="sidebar">
		...
		<ul class="nav navbar-nav">	
			...
			<li><a class="nav-link" href="/user/dash">
				<span class="dz-icon">
			...
			<li><a class="nav-link" href="{{ route('user.logout') }}">
				<span class="dz-icon">
	...
	<div class="menubar-area">
		<div class="toolbar-inner menubar-nav">			
            <a href="/user/reports" class="nav-link {{ (request()->segment(2) == 'reports') ? 'active' : '' }}">
            ...
            <a href="/user/misc" class="nav-link {{ (request()->segment(2) == 'misc') ? 'active' : '' }}">
			...
			<a href="/user/dash" class="nav-link {{ (request()->segment(2) == 'dash') ? 'active' : '' }}">
			...
			<a href="/user/buy" class="nav-link {{ (request()->segment(2) == 'buy') ? 'active' : '' }}">
			...
			<a href="/user/profile" class="nav-link {{ (request()->segment(2) == 'profile') ? 'active' : '' }}">
